...
int main(int argc, char *argv[]) {
  ...
  string filename = "SignalSelection_InvMass_regionB_IsoTrack_all_fix";
  string moreCuts = "(PionTriplet_pt>40)&&(((IsoTrack_pfRelIso03_all / IsoTrack_pt)>=0.01) || ((IsoTrack_pfRelIso03_all / IsoTrack_pt)<0.01))";
  bool logy = false;
