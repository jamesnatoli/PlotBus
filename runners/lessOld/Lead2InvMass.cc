...
int main(int argc, char *argv[]) {
  ...
  plotbus->filename = "Lead2InvMass_DeepJetMed_charge1_genPartFlav5";
  plotbus->variable = "PionTriplet_MassInv_lead2";
  ...
  plotbus->addCuts = "(PionTriplet_LowestDeepTauVsJet >= 31) && (Tau_genPartFlav == 5)";
